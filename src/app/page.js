...
const Page = () => {
  ...
  const cardArray = [
    {
      img: <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-mail" width="44" height="44"
    ...
    {
      img: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" shape-rendering="geometricPrecision"
                textRendering="geometricPrecision" imageRendering="optimizeQuality" fill-rule="evenodd"
                clip-rule="evenodd">
        <defs>
          <mask id="c">
          ...
          <radialGradient id="f" gradientUnits="userSpaceOnUse" cx="9696.85" cy="10000.4" r="166667" fx="9696.85"
                          fy="10000.4">
        ...
        <g fill-rule="nonzero">
          ...
          <path d="M22728 0C10226 0 0 10227 0 22729v1893C0 12123 10227 1894 22728 1894h128784V1H22728z" fill="#fff"
                fill-opacity=".2"/>
          <path
